...
function init() {
    ...
    directionalLight.position.set( 0, 1.25, 2.5 )
...
function animate() {
    ...
    // Update objects
    directionalLight.position.z = Math.sin( ( elapsedTime + 25 ) / 25 ) * 2.5
    directionalLight.position.x = Math.cos( ( elapsedTime + 25 ) / 25 ) * 2.5
